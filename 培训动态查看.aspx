<%@ Page Language="C#" AutoEventWireup="true" CodeFile="培训动态查看.aspx.cs" Inherits="培训动态查看" %>
...
<body>
    <form id="form1" runat="server"><p align=center>
    <asp:Image ID="Image1" runat="server" ImageUrl="~/IMAGES/top1.jpg" 
            Width="80%" /></p>
            <p align=center>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            ...
            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                ...
                <asp:HyperLink ID="HyperLink1" runat="server" Font-Names="微软雅黑" 
                    NavigateUrl="~/培训动态总览.aspx" Font-Size="X-Large">培训动态</asp:HyperLink></p>
    <div align=center>
        ...
        <table  width="50%" >
            ...
            </tr><tr><td align=center><asp:Panel ID="Panel1" runat="server">
    </asp:Panel></td></tr>
        </table>
